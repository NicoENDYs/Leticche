    ...
    productos.forEach((producto) => {
      ...
      carritoHTML += `
                        <div class="carrito-item" data-id="${producto.id}">
                            <img class="carrito-item-imagen" src="../img/${
                              producto.imagen
                            }" alt="${producto.nombre}">
                            <div class="carrito-item-detalles">
                                ...
                                <p class="carrito-item-precio" id="precioProducto${
                                  producto.id
                                ...
                                <div class="carrito-item-acciones">
                                    <div class="cantidad-control">
                                        ...
                                        <p class="cantidad-numero" id="cantidadProducto${
                                          producto.id
                                        }">${producto.cantidad}</p>
                                    ...
                                    <button class="eliminar-btn" onclick="eliminarProducto(${
                                      producto.id
                                    })" data-id="${producto.id}">Eliminar</button>
                                </div>
                            </div>
                            <div class="carrito-item-subtotal" id="idTotalProducto${
                              producto.id
